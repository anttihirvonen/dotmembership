...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        # Adding field 'Invoice.fee'
        db.add_column('billing_invoice', 'fee',
                      self.gf('django.db.models.fields.related.ForeignKey')(default=None, to=orm['billing.AnnualFee'], null=True),
                      keep_default=False)


    def backwards(self, orm):
        # Deleting field 'Invoice.fee'
        db.delete_column('billing_invoice', 'fee_id')
